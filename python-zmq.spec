...
Source0:        https://github.com/zeromq/pyzmq/releases/download/v%{version}/pyzmq-%{version}.tar.gz
...
%endif
%defattr(-,root,root,-)
%doc README.md COPYING.LESSER examples/
...
%changelog
* Tue Oct 29 2013 Massimiliano Torromeo <massimiliano.torromeo@gmail.com> - 14.0.0-1
